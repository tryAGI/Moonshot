...
namespace Moonshot
{
    public partial class BatchClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_GetBatchesByBatchIdSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_GetBatchesByBatchIdSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
            {                s_GetBatchesByBatchIdSecurityRequirement0,
            };
        partial void PrepareGetBatchesByBatchIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string batchId);
        partial void PrepareGetBatchesByBatchIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string batchId);
        partial void ProcessGetBatchesByBatchIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetBatchesByBatchIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.BatchObject> GetBatchesByBatchIdAsync(
            string batchId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetBatchesByBatchIdAsResponseAsync(
                batchId: batchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<global::Moonshot.BatchObject>> GetBatchesByBatchIdAsResponseAsync(
            string batchId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetBatchesByBatchIdArguments(
            ...
            var __authorizations = global::Moonshot.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetBatchesByBatchIdSecurityRequirements,
                operationName: "GetBatchesByBatchIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetBatchesByBatchIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Moonshot.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetBatchesByBatchIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetBatchesByBatchIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetBatchesByBatchIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
