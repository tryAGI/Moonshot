...
namespace Moonshot
{
    ...
    public sealed partial class ChatRequestCommonPrediction
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Moonshot.JsonConverters.ChatRequestCommonPredictionTypeJsonConverter))]
        public global::Moonshot.ChatRequestCommonPredictionType? Type { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatRequestCommonPrediction" /> class.
        /// </summary>
        /// <param name="type">
        /// The type of the predicted content. Currently only content is supported.
        /// </param>
...
#endif
        public ChatRequestCommonPrediction(
            global::Moonshot.ChatRequestCommonPredictionType? type,
