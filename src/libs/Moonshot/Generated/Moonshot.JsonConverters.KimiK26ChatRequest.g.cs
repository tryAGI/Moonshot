...
{
    /// <inheritdoc />
    public class KimiK26ChatRequestJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Moonshot.KimiK26ChatRequest>
    {
        /// <inheritdoc />
        public override global::Moonshot.KimiK26ChatRequest Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            global::Moonshot.KimiK26ChatRequestVariant2? kimiK26ChatRequestVariant2 = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        kimiK26ChatRequestVariant2 = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (@base == null && kimiK26ChatRequestVariant2 == null)
            {
                try
                {
            ...
            var __value = new global::Moonshot.KimiK26ChatRequest(
                @base,
        ...
        public override void Write(
            ...
            global::Moonshot.KimiK26ChatRequest value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");
            ...
            else if (value.IsKimiK26ChatRequestVariant2)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Moonshot.KimiK26ChatRequestVariant2), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Moonshot.KimiK26ChatRequestVariant2?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Moonshot.KimiK26ChatRequestVariant2).Name}");
                global::System.Text.Json.JsonSerializer.Serialize(writer, value.KimiK26ChatRequestVariant2!, typeInfo);
            }
        }
    }
}