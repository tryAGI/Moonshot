...
namespace Moonshot
{
    public partial class BatchClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_CreateBatchesByBatchIdCancelSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_CreateBatchesByBatchIdCancelSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
            {                s_CreateBatchesByBatchIdCancelSecurityRequirement0,
            };
        partial void PrepareCreateBatchesByBatchIdCancelArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string batchId);
        partial void PrepareCreateBatchesByBatchIdCancelRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string batchId);
        partial void ProcessCreateBatchesByBatchIdCancelResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateBatchesByBatchIdCancelResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.BatchObject> CreateBatchesByBatchIdCancelAsync(
            string batchId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateBatchesByBatchIdCancelAsResponseAsync(
                batchId: batchId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<global::Moonshot.BatchObject>> CreateBatchesByBatchIdCancelAsResponseAsync(
            string batchId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareCreateBatchesByBatchIdCancelArguments(
            ...
            var __authorizations = global::Moonshot.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateBatchesByBatchIdCancelSecurityRequirements,
                operationName: "CreateBatchesByBatchIdCancelAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateBatchesByBatchIdCancelRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Moonshot.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createBatchesByBatchIdCancel",
                                methodName: "CreateBatchesByBatchIdCancelAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateBatchesByBatchIdCancelResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request - Task status does not allow cancellation
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw new global::Moonshot.ApiException<global::Moonshot.ErrorResponse>(
                            ...
                            if ((int)__response.StatusCode == 401)
                            {
                                ...
                                global::Moonshot.ErrorResponse? __value_401 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_401 = global::Moonshot.ErrorResponse.FromJson(__content_401, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_401 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateBatchesByBatchIdCancelResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Moonshot.BatchObject.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Moonshot.AutoSDKHttpResponse<global::Moonshot.BatchObject>(
                                        statusCode: __response.StatusCode,
                                ...
                                {
                                    throw new global::Moonshot.ApiException(
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Moonshot.BatchObject.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
