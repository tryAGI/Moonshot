...
namespace Moonshot
{
    ...
    public sealed partial class ChatRequestCommonResponseFormat
    {
        ...
        [global::System.Text.Json.Serialization.JsonConverter(typeof(global::Moonshot.JsonConverters.ChatRequestCommonResponseFormatTypeJsonConverter))]
        public global::Moonshot.ChatRequestCommonResponseFormatType? Type { get; set; }

        /// <summary>
        /// Used when type is json_schema. Defines the JSON Schema that the output should conform to.
        /// </summary>
        [global::System.Text.Json.Serialization.JsonPropertyName("json_schema")]
        public global::Moonshot.ChatRequestCommonResponseFormatJsonSchema? JsonSchema { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ChatRequestCommonResponseFormat" /> class.
        /// </summary>
        /// <param name="type">
        /// Output format type. text: default, plain text output; json_object: ensures output is a valid JSON object; json_schema: constrains output to match a specified JSON Schema (recommended, requires the json_schema field)
        /// </param>
...
#endif
        public ChatRequestCommonResponseFormat(
            global::Moonshot.ChatRequestCommonResponseFormatType? type,
            global::Moonshot.ChatRequestCommonResponseFormatJsonSchema? jsonSchema)
        {
            this.Type = type;
