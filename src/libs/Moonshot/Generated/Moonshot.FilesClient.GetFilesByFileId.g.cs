...
namespace Moonshot
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_GetFilesByFileIdSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_GetFilesByFileIdSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
            {                s_GetFilesByFileIdSecurityRequirement0,
            };
        partial void PrepareGetFilesByFileIdArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId);
        partial void PrepareGetFilesByFileIdRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string fileId);
        partial void ProcessGetFilesByFileIdResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFilesByFileIdResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.FileObject> GetFilesByFileIdAsync(
            string fileId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetFilesByFileIdAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<global::Moonshot.FileObject>> GetFilesByFileIdAsResponseAsync(
            string fileId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFilesByFileIdArguments(
            ...
            var __authorizations = global::Moonshot.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFilesByFileIdSecurityRequirements,
                operationName: "GetFilesByFileIdAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFilesByFileIdRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Moonshot.AutoSDKRequestOptionsSupport.CreateHookContext(
                                ...
                                methodName: "GetFilesByFileIdAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFilesByFileIdResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFilesByFileIdResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
