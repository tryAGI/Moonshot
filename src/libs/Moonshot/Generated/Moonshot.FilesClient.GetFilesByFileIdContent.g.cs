...
namespace Moonshot
{
    public partial class FilesClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_GetFilesByFileIdContentSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_GetFilesByFileIdContentSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
            {                s_GetFilesByFileIdContentSecurityRequirement0,
            };
        partial void PrepareGetFilesByFileIdContentArguments(
            global::System.Net.Http.HttpClient httpClient,
            ref string fileId);
        partial void PrepareGetFilesByFileIdContentRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            string fileId);
        partial void ProcessGetFilesByFileIdContentResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessGetFilesByFileIdContentResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<string> GetFilesByFileIdContentAsync(
            string fileId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await GetFilesByFileIdContentAsResponseAsync(
                fileId: fileId,
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<string>> GetFilesByFileIdContentAsResponseAsync(
            string fileId,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            PrepareArguments(
                client: HttpClient);
            PrepareGetFilesByFileIdContentArguments(
            ...
            var __authorizations = global::Moonshot.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_GetFilesByFileIdContentSecurityRequirements,
                operationName: "GetFilesByFileIdContentAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareGetFilesByFileIdContentRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Moonshot.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "getFilesByFileIdContent",
                                methodName: "GetFilesByFileIdContentAsync",
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessGetFilesByFileIdContentResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessGetFilesByFileIdContentResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    return new global::Moonshot.AutoSDKHttpResponse<string>(
                                        statusCode: __response.StatusCode,
