...
namespace Moonshot
{
    public partial class ResponsesClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_CreateResponsesSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_CreateResponsesSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.ResponsesResponse> CreateResponsesAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<global::Moonshot.ResponsesResponse>> CreateResponsesAsResponseAsync(
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 403)
                            {
                                ...
                                global::Moonshot.ErrorResponse? __value_403 = null;
                                try
                                {
                                    if (__effectiveReadResponseAsString)
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                                        __value_403 = global::Moonshot.ErrorResponse.FromJson(__content_403, JsonSerializerContext);
                                    }
                                    else
                                    {
                                        __content_403 = await __response.Content.ReadAsStringAsync(__effectiveCancellationToken).ConfigureAwait(false);
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Moonshot.ResponsesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Moonshot.AutoSDKHttpResponse<global::Moonshot.ResponsesResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Moonshot.ResponsesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
