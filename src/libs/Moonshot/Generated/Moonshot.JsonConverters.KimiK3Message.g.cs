...
{
    /// <inheritdoc />
    public class KimiK3MessageJsonConverter : global::System.Text.Json.Serialization.JsonConverter<global::Moonshot.KimiK3Message>
    {
        /// <inheritdoc />
        public override global::Moonshot.KimiK3Message Read(
            ...
            global::System.Text.Json.JsonSerializerOptions options)
        {
            ...
            if (__jsonProps.Contains("partial")) __score0++;
            ...
            global::Moonshot.Message? standardMessage = default;
            global::Moonshot.KimiK3DynamicToolMessage? dynamicToolMessage = default;
            if (__bestIndex >= 0)
            {
                if (__bestIndex == 0)
                {
                    try
                    {
                        ...
                        standardMessage = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                ...
                else if (__bestIndex == 1)
                {
                    try
                    {
                        ...
                        dynamicToolMessage = global::System.Text.Json.JsonSerializer.Deserialize(__rawJson, typeInfo);
                    }
                    catch (global::System.Text.Json.JsonException)
                    {
                    }
            ...
            if (standardMessage == null && dynamicToolMessage == null)
            {
                try
                {
            ...
            var __value = new global::Moonshot.KimiK3Message(
                standardMessage,
        ...
        public override void Write(
            ...
            global::Moonshot.KimiK3Message value,
            global::System.Text.Json.JsonSerializerOptions options)
        {
            options = options ?? throw new global::System.ArgumentNullException(nameof(options));
            var typeInfoResolver = options.TypeInfoResolver ?? throw new global::System.InvalidOperationException("TypeInfoResolver is not set.");

            if (value.IsStandardMessage)
            {
                var typeInfo = typeInfoResolver.GetTypeInfo(typeof(global::Moonshot.Message), options) as global::System.Text.Json.Serialization.Metadata.JsonTypeInfo<global::Moonshot.Message?> ??
                               throw new global::System.InvalidOperationException($"Cannot get type info for {typeof(global::Moonshot.Message).Name}");
