...
namespace Moonshot
{
    public partial class ToolsClient
    {
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement s_CreateToolsFetchSecurityRequirement0 =
        ...
        private static readonly global::Moonshot.EndPointSecurityRequirement[] s_CreateToolsFetchSecurityRequirements =
            new global::Moonshot.EndPointSecurityRequirement[]
            {                s_CreateToolsFetchSecurityRequirement0,
            };
        partial void PrepareCreateToolsFetchArguments(
            global::System.Net.Http.HttpClient httpClient,
            global::Moonshot.ToolsFetchRequest request);
        partial void PrepareCreateToolsFetchRequest(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpRequestMessage httpRequestMessage,
            global::Moonshot.ToolsFetchRequest request);
        partial void ProcessCreateToolsFetchResponse(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage);

        partial void ProcessCreateToolsFetchResponseContent(
            global::System.Net.Http.HttpClient httpClient,
            global::System.Net.Http.HttpResponseMessage httpResponseMessage,
            ref string content);
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.ToolsFetchResponse> CreateToolsFetchAsync(

            global::Moonshot.ToolsFetchRequest request,
            global::Moonshot.AutoSDKRequestOptions? requestOptions = default,
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __response = await CreateToolsFetchAsResponseAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Moonshot.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Moonshot.AutoSDKHttpResponse<global::Moonshot.ToolsFetchResponse>> CreateToolsFetchAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            PrepareArguments(
                client: HttpClient);
            PrepareCreateToolsFetchArguments(
            ...
            var __authorizations = global::Moonshot.EndPointSecurityResolver.ResolveAuthorizations(
                ...
                securityRequirements: s_CreateToolsFetchSecurityRequirements,
                operationName: "CreateToolsFetchAsync");
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                PrepareRequest(
                    client: HttpClient,
                    request: __httpRequest);
                PrepareCreateToolsFetchRequest(
                    httpClient: HttpClient,
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            ...
                            context: global::Moonshot.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "createToolsFetch",
                                methodName: "CreateToolsFetchAsync",
                                pathTemplate: "\"/v1/tools/fetch\"",
                                httpMethod: "POST",
                                baseUri: BaseUri,
                                request: __httpRequest!,
                                response: null,
                ...
                ProcessResponse(
                    client: HttpClient,
                    response: __response);
                ProcessCreateToolsFetchResponse(
                    httpClient: HttpClient,
                ...
                else
                {
                    await global::Moonshot.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            // Bad request - Invalid parameters or malformed URL
                            ...
                            // Forbidden - account inactive or suspended (no error body), or the URL was blocked by security risk control (returns a security_risk error)
                            ...
                            // No extractable content found for the URL (markdown_not_found)
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                ProcessCreateToolsFetchResponseContent(
                                    httpClient: HttpClient,
                                    httpResponseMessage: __response,
                                    content: ref __content);
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Moonshot.ToolsFetchResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Moonshot.AutoSDKHttpResponse<global::Moonshot.ToolsFetchResponse>(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Moonshot.ToolsFetchResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
        ...
        public async global::System.Threading.Tasks.Task<global::Moonshot.ToolsFetchResponse> CreateToolsFetchAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            var __request = new global::Moonshot.ToolsFetchRequest
            {
                Url = url,
            };

            return await CreateToolsFetchAsync(
                request: __request,
                requestOptions: requestOptions,
