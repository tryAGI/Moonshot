...
namespace Moonshot
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Moonshot.AutoSDKRetryOptions Retry { get; set; } = new global::Moonshot.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Moonshot.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Moonshot.IAutoSDKHook>();
        ...
        public global::Moonshot.AutoSDKClientOptions AddHook(
            global::Moonshot.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Moonshot.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Moonshot.AutoSDKClientOptions UseAuthorizationProvider(
            global::Moonshot.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Moonshot.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Moonshot.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Moonshot.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Moonshot.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Moonshot.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Moonshot.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Moonshot.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Moonshot.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Moonshot.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Moonshot.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Moonshot.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Moonshot.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Moonshot.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Moonshot.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Moonshot.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Moonshot.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Moonshot.AutoSDKClientOptions clientOptions,
            global::Moonshot.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Moonshot.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Moonshot.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Moonshot.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Moonshot.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Moonshot.IAutoSDKHook, global::Moonshot.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Moonshot.AutoSDKHookContext context)
        {
